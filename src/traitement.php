...
if (isset($_POST['pass1jourReduit']) && !empty($_POST['pass1jourReduit'])) {
    ...
    header('location:../index.php?erreur=' . PASS1REDUIT);
}
...
$user = new User($nom, $prenom, $mail, $mdp, $telephone, $adresse);
...
if ($retour) {
        ...
        die;//Il termine le script avec die pour empêcher l'exécution ultérieure du code.
    }
